...
export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen bg-[#EED8B2] text-[#4A2E45]">
      <Navigation />
      <section className="bg-[#4A2E45] px-6 pb-20 pt-40 text-center text-white">
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-3xl rounded-3xl bg-[#FFF3DF] p-8 shadow-xl shadow-[#69465F]/15 md:p-12">
          <div className="space-y-9 leading-7 text-stone-700">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">1. Who is responsible for your information?</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">2. Information we collect</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">3. How we use information and our legal bases</h2>
              <ul className="mt-3 list-disc space-y-2 pl-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">4. Optional AI recipe reader</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">5. Who we share information with</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">6. How long we keep information</h2>
              <ul className="mt-3 list-disc space-y-2 pl-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">7. Your rights</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">8. Security and complaints</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">9. Cookies and changes to this notice</h2>
