      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-3xl rounded-3xl bg-[#FFF3DF] p-8 shadow-xl shadow-[#69465F]/15 md:p-12">
          <div className="space-y-8 leading-7 text-stone-700">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">Website analytics</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">Your browser storage</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">If this changes</h2>
