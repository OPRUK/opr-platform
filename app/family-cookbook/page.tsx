...
export default function FamilyCookbook() {
  return (
    <main className="min-h-screen bg-[#EED8B2] text-[#123C39]">
      ...
      <section className="relative isolate overflow-hidden bg-[#123C39] px-6 pb-16 pt-40 text-center text-white">
        <video
      ...
      <section className="bg-[#FFF3DF] px-6 py-16 text-center">
        <p className="text-sm uppercase tracking-[0.35em] text-amber-700">
          Whet Our Appetite
        </p>
        ...
        <Link
          href="/share"
          className="mt-7 inline-block rounded-full bg-[#123C39] px-8 py-4 text-lg font-medium text-white transition hover:scale-105"
        >
          Share Your Story
        </Link>
      </section>
