      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-3xl rounded-3xl bg-[#FFF3DF] p-8 shadow-xl shadow-[#69465F]/15 md:p-12">
          <div className="space-y-9 leading-7 text-stone-700">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">1. Using OPR</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">2. Submitting a recipe or community contribution</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">3. Our editorial role</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">4. Cooking, allergies and health</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">5. OPR content and links</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">6. Availability and liability</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">7. Privacy and changes</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#4A2E45]">8. Contact and governing law</h2>
