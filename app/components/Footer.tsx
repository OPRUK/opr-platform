  ...
  return (
    <footer className="bg-[#08231F] px-6 py-16 text-[#FFF3DF]">
      <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          <p className="font-brand text-4xl font-semibold leading-none tracking-[0.01em]">Other People&apos;s Recipes<sup className="ml-0.5 align-super text-[0.38em] font-sans font-semibold">™</sup></p>
