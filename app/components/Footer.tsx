...
export default function Footer() {
  return (
    <footer className="bg-[#2A1025] px-6 py-16 text-[#FFF3DF]">
          ...
          <ul className="mt-5 space-y-3 text-[#FFF3DF]">
            ...
            <li className="flex items-center gap-4 pt-2">
              <a
                ...
                className="rounded-full border border-[#8B6B42] p-2.5 text-[#FFF3DF] transition hover:-translate-y-0.5 hover:border-[#DDB765] hover:bg-[#DDB765] hover:text-[#2A1025]"
              >
      ...
      <div className="mx-auto mt-14 flex max-w-6xl flex-col gap-3 border-t border-[#69465F] pt-6 text-sm text-[#DABF8D] sm:flex-row sm:items-center sm:justify-between">
        <div>
