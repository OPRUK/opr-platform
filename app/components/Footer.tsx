    ...
    <footer className="bg-[#08231F] px-6 py-16 text-[#FFF3DF]">
      <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-5 max-w-sm leading-7 text-[#DDB765]">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-[#FFF3DF]">
            ...
            <li><Link href="/join-our-table" className="transition hover:text-[#DDB765]">Join Our Table</Link></li>
      ...
      <div className="mx-auto mt-14 flex max-w-6xl flex-col gap-3 border-t border-[#1C5A50] pt-6 text-sm text-[#DDB765] sm:flex-row sm:items-center sm:justify-between">
        <div>
