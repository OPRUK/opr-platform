...
const inputClassName =
  "mt-1.5 w-full border border-[#D1AD75] bg-[#F4DDAE] px-3.5 py-2.5 text-[15px] outline-none transition placeholder:text-stone-500 focus:border-[#4A2E45]";
...
export default function AddCookForm({
  ...
  if (submitted) {
    return (
      <p className="mt-4 border border-[#4A2E45]/35 bg-[#FFF3DF] p-4 text-center text-sm leading-6">
  ...
  if (open) {
    return (
      <form onSubmit={submit} className="mt-4 border border-[#4A2E45]/35 bg-[#FFF3DF] p-4">
        ...
        <label className="mt-3.5 block text-sm font-medium">
          ...
          <input
            ...
            className="mt-1.5 block w-full text-sm file:mr-3 file:border-0 file:bg-[#4A2E45] file:px-3.5 file:py-2 file:text-sm file:font-medium file:text-[#EED8B2]"
          />
        </label>
        ...
        <button
          ...
          className="mt-4 w-full bg-[#4A2E45] px-[18px] py-3.5 text-[15px] font-medium text-[#EED8B2] transition hover:bg-[#2C1328] disabled:cursor-not-allowed disabled:opacity-50"
        >
  ...
  return (
    <>
      <button
        ...
        className="mt-4 flex w-full items-center gap-2 bg-[#4A2E45] px-[18px] py-4 text-[17px] font-medium text-[#EED8B2] transition hover:bg-[#2C1328]"
      >
