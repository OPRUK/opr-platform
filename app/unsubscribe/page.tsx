  ...
  return (
    <main className="min-h-screen bg-[#EED8B2] text-[#4A2E45]">
      ...
      <section className="px-6 pb-24 pt-40">
        <div className="mx-auto max-w-2xl rounded-3xl bg-[#FFF3DF] p-8 shadow-xl shadow-[#69465F]/15 md:p-12">
          ...
          {valid ? (
            ...
            <>
              ...
              <Link href="/contact" className="mt-8 inline-block rounded-full bg-[#4A2E45] px-7 py-4 font-medium text-white transition hover:bg-[#2A1025]">Get in touch</Link>
            </>
          )}
        </div>
      </section>
